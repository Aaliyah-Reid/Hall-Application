...
public class RexNettlefordHall implements HallOfResidence {
    private int numRoom;
    private int budget = 100000;
    private String aRoom;
    private int index, count;
    private Block blockA = new Block("RNH", "A");
    private Block blockB = new Block("RNH", "B");
    private Block blockC = new Block("RNH", "C");
    private Block blockD = new Block("RNH", "D");
